...
Treemap 是一款为 Obsidian 打造的极致极简、美感十足的矩阵图插件。它将您的笔记库视作一座数字花园，通过动态的色块分布，让您一眼洞察知识的深度与生命力。
...
2. 在您的 Obsidian 库中，创建目录 `.obsidian/plugins/obsidian-treemap`。
3. 将下载的文件放入该目录。
4. 在设置中重启并启用插件。
...
Treemap is a premium, aesthetic visualization plugin for Obsidian. It treats your vault as a digital garden, allowing you to perceive the depth and vitality of your knowledge thru dynamic color blocks.
